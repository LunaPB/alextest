...
/*  A Bison parser, made from carrito.b  */
...
static const short yyrline[] = {     0,
  20,  23,  24,  27,  28,  29,  30,  31
};

static const char * const yytname[] = {     0,
"error","$illegal.","ADELANTE","ATRAS","IZQUIERDA","DERECHA","ALTO","programa"
};
...
-32767,-32767,-32767,-32767,-32767,    -3,-32767,-32767,     5,     6,
-32767
};
...
case 6:
#line 29 "carrito.b"
{ fprintf(yyout, "  izquierda();\n  delay(1000);\n"); ;
    break;}
case 7:
#line 30 "carrito.b"
{ fprintf(yyout, "  derecha();\n  delay(1000);\n"); ;
    break;}
case 8:
#line 31 "carrito.b"
{ fprintf(yyout, "  alto();\n  delay(1000);\n"); ;
...
void main(void)
{
    ...
    yyout = fopen("c:\\turboc3\\bin\\bison\\prueba.ino", "w");
    if (yyout == NULL) {
